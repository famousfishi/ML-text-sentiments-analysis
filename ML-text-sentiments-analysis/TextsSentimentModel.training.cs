...
namespace ML_text_sentiments_analysis
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Oluwafisayomi\Desktop\ML projects\ML-text-sentiments-analysis\ML-text-sentiments-analysis\yelp_labelled.txt";
